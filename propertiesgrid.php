                    ...
                    ?>
                        <div class="col-sm-6 col-md-3 p0">
                            <div class="box-two proerty-item">
                                ...
                                <a href="#" onclick="return showAlert('question', 'Please Login', 'You need to login to view property details', 'login.php');">
                                ...
                                <h6><a href="#" onclick="return showAlert('question', 'Please Login', 'You need to login to view property details', 'login.php');"> <?php echo $row['property_name']; ?> </a></h6>
        ...
        listContainer.innerHTML = properties.map(property => `
            <div class="col-sm-6 col-md-3 p0">
                <div class="box-two proerty-item">
                    ...
                    <div class="item-entry overflow">
                        <h6><a href="#" onclick="return showAlert('question', 'Please Login', 'You need to login to view property details', 'login.php');">${property.property_name}</a></h6>
