...
$query = "SELECT aemail, aname, aimage FROM agents WHERE aid = ?";
...
if ($result->num_rows > 0) {
    ...
    error_log("Agent ID $agent_id not found in the database.");
            ...
            <div class="agent-image-item visible-xs">
                <div class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <?php if (!empty($agent['aimage'])): ?>
                            <img src="data:image/jpeg;base64,<?php echo base64_encode($agent['aimage']); ?>" alt="Agent Image" class="agent-image">
                        <?php else: ?>
                            <img src="assets/img/default-user.png" alt="Default Agent Image" class="agent-image">
                        <?php endif; ?>
                    </a>
            ...
            <ul class="main-nav nav navbar-nav navbar-right">
                ...
                <li class="dropdown ymm-sw">
                    ...
                    <ul class="dropdown-menu navbar-nav">
                        <li><a href="propertygrid.php">Property Grid</a></li>
                        <li><a href="addproperty.php">Add Property</a></li>
                        <li><a href="manageproperty.php">Manage Property</a></li>
                    </ul>
                </li>
                <li><a href="manageenquiries.php">Property Enquiries</a></li>
