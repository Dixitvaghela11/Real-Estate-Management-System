<?php
include("include/header.php"); // Include header file with session and navigation
...
$total_query = "SELECT COUNT(*) as total FROM agents";
$total_result = $conn->query($total_query);
$total_rows = $total_result->fetch_assoc()['total'];
$total_pages = ceil($total_rows / $results_per_page);

// Modify the main query to include pagination
$query = "SELECT * FROM agents LIMIT $offset, $results_per_page";
    ...
    <div class="row">
      <div class="col-md-12 col-lg-8">
        <div class="title-single-box">
          <h1 class="title-single" style="color: #000066;">Our Amazing Agents</h1>
        ...
        <ul class="pagination d-flex justify-content-center align-items-center">
          ...
          <li class="page-item <?php echo ($page <= 1) ? 'disabled' : ''; ?>">
            <a class="page-link" href="<?php echo ($page <= 1) ? '#' : '?page='.($page-1); ?>" 
               style="color: #000066; margin-right: 10px;">
          ...
          if ($start > 1) {
              echo '<li class="page-item"><a class="page-link" href="?page=1" style="color: #000066;">1</a></li>';
              if ($start > 2) {
          ...
          for($i = $start; $i <= $end; $i++): ?>
            <li class="page-item <?php echo ($i == $page) ? 'active' : ''; ?>">
              <a class="page-link" href="?page=<?php echo $i; ?>" 
                 style="<?php echo ($i == $page) ? 'background-color: #000066; border-color: #000066; color: white;' : 'color: #000066;'; ?>">
                <?php echo $i; ?>
              </a>
            </li>
          <?php endfor;
          ...
          if ($end < $total_pages) {
              ...
              echo '<li class="page-item"><a class="page-link" href="?page='.$total_pages.'" style="color: #000066;">'.$total_pages.'</a></li>';
          }
          ?>
          ...
          <li class="page-item <?php echo ($page >= $total_pages) ? 'disabled' : ''; ?>">
            <a class="page-link" href="<?php echo ($page >= $total_pages) ? '#' : '?page='.($page+1); ?>" 
               style="color: #000066; margin-left: 10px;">
