                ...
                <div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li class="submenu">
								<a href="#"><i class="fe fe-comment"></i> <span> Contact,Testimonials </span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
									<li><a href="contactview.php"> Contact </a></li>
									<li><a href="feedbackview.php"> Testimonials </a></li>
								</ul>
							</li>
							<li class="menu-title"> 
								<span>Property Enquirys</span>
							</li>
						
							<li class="submenu">
								<a href="#"><i class="fe fe-search"></i> <span>Property Enquiry</span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
									<li><a href="enquiryview.php"> Enquiry </a></li>
								</ul>
							</li>
							<li class="menu-title"> 
							...
							<li class="submenu">
								<a href="#"><i class="fe fe-browser"></i> <span> Property Review </span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
									<li><a href="propertyreview.php"> Property Review </a></li>
								</ul>
							</li>
