...
// Retrieve properties associated with the user from the wishlist
$query = "SELECT p.* FROM wishlist w JOIN property p ON w.p_id = p.p_id WHERE w.uid = ? LIMIT ? OFFSET ?";
$stmt = $conn->prepare($query);
...
$total_query = "SELECT COUNT(*) AS total FROM wishlist WHERE uid = ?";
