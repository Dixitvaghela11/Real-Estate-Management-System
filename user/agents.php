              ...
              <div class="col-md-4">
                <div class="card-box-d">
                  <div class="card-img-d">
                    <img  src="data:image/jpg;base64,<?php echo base64_encode($row['aimage']); ?>" alt="" class="img-d img-fluid">
                  </div>
                  <div class="card-overlay card-overlay-hover">
                    <div class="card-header-d">
                      <div class="card-title-d align-self-center">
                        <h1 class="title-d">
                          <a href="#" style="font-size: 30px;" class="link-two"><?php echo $row['aname']; ?></a>
                        </h1>
                      </div>
                    </div>
